...
src/services/           commands, events, level flow, native menu, files, input, hud, pods
src/format/ registry/ modset/ pod/ bus/ cmd/ input/ menu/     pure packages, tested offline
